namespace IntegratieOpdrachtPolDeel3.Models
{
    public class Caravan : Aanhangwagen, IBewoonbaar
    {
        ...
        public Caravan(int aantalbanden, int gewicht, double bewoonbaarOppervlakte, string eigenaar, double prijs, int huidigeBelading, int maximumLaadGewicht) : base(aantalbanden, gewicht, eigenaar, prijs, huidigeBelading, maximumLaadGewicht)
        {
            aantalSlaapkamers = 1;
