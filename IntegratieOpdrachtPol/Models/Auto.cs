...
namespace IntegratieOpdrachtPol.Models
{
    public class Auto : IVoertuig, ITrekker
    {
        ...
        public Auto(double maximaalTrekGewicht, int maximumSnelheid, string merk, int snelheid)
        {
        ...
        public void KoppelAanhangwagen(ITrekbaar aanhangwagen)
        {
            if (snelheid > 0)
            {
                throw new ArgumentException("Er kan geen aanhangwagen gekoppeld worden terwijl de auto rijdt!");
            }
